package org.tang.myjob.utils.image;
...
public class ImageUtil {
    ...
    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(ImageUtil.class.getName());
        ...
        if(imgFile.exists()){
            try {
                ...
                if(!force){
                    ...
                    if((width*1.0)/w < (height*1.0)/h) if (width > w) {
